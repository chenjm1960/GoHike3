...
/*
 ...
 case standard(String), hybrd(String), satellite(String), flyover(String)
 ...
 var viewTypes = ViewTypes.standard("standard")
 ...
 case .satellite:
 mapView.mapType = .satellite
 viewTypes = ViewTypes.hybrd("hybrid")
 sender.setTitle("\(viewTypes)", for: [])
 case .hybrd:
 mapView.mapType = .hybrid
 viewTypes = ViewTypes.hybrd("standard")
 sender.setTitle("\(viewTypes)", for: [])
 case .standard:
 mapView.mapType = .standard
 viewTypes = ViewTypes.hybrd("satellite")
 sender.setTitle("\(viewTypes)", for: [])
 default:
 print("No selection")
 }
 ...
 mapView.showsBuildings = true
 mapView.setCamera(camera, animated: true)
 viewTypes = ViewTypes.flyover("flyover")
 }
